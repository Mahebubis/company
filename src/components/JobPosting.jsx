...
// function DateRangeFilter({ value, onChange, label, disabled = false }) {
...
//     return () => document.removeEventListener('mousedown', h); // ✅ FIX
//   }, []);
...
//           setOpen(o => !o);
//           if (!open) {
//             onChange?.(value); // optional sync if needed
//           }
//         }}
...
//         <div className="absolute top-full left-0 mt-1 bg-white border border-slate-200 rounded-xl shadow-xl z-[999] p-3 min-w-[220px]"
//           onMouseDown={(e) => e.stopPropagation()}  // ✅ VERY IMPORTANT
//           onClick={e => e.stopPropagation()}>
//           <p className="text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-2">{label} Date Range</p>
//           <div className="space-y-2">
//             <div>
//               <label className="text-[10px] text-slate-400 font-medium block mb-1">From</label>
//               {/* <input type="date" onMouseDown={(e) => e.stopPropagation()}  // ✅ prevents closing value={value?.from ?? ''}
...
//             </div>
//             <div>
//               <label className="text-[10px] text-slate-400 font-medium block mb-1">To</label>
//               {/* <input type="date" onMouseDown={(e) => e.stopPropagation()}  // ✅ prevents closing value={value?.to ?? ''}
...
//                 setOpen(false);
//               }}
//               className="w-full bg-indigo-600 text-white text-[11px] py-1.5 rounded-lg font-semibold hover:bg-indigo-700 transition-all"
//             >
//               Apply
//             </button>
//             <button onClick={() => { onChange({ from: '', to: '' }); setOpen(false); }}
//               className="w-full text-[10px] text-slate-400 hover:text-red-500 text-center mt-1 transition-colors">
//               Clear dates
//             </button>
//           </div>
//         </div>
            ...
            <tr>
              ...
              <ColHeader col="applications" label="Applications" sortKey="total_applications"
                ...
                <div className="space-y-1">
                  ...
                  {/* <DateRangeFilter
                    value={appDateRange}
                    onChange={(v) => { setAppDateRange(v); setPage(1); }}
                    label="Application"
                  /> */}
                  {/* <DateRangeFilter
                    value={appDateRange}
              ...
              <ColHeader col="features" label="Features Used"
                ...
                <div className="space-y-1">
                  ...
                  {/* <DateRangeFilter
                    value={featDateRange}
                    onChange={(v) => { setFeatDateRange(v); setPage(1); }}
                    label="Feature"
                  /> */}
                  {/* <DateRangeFilter
                    value={featDateRange}

...
export default function Companies() {
  ...
  useEffect(() => {
    const t = setTimeout(fetchCompanies, search || locationSearch || websiteSearch || noteSearch ? 400 : 0);
    return () => clearTimeout(t);
  }, [fetchCompanies]);
          ...
          <thead className="sticky top-0 z-[20]">
            <tr>
              ...
              <ColHeader col="website" label="Website" filterActive={!!websiteSearch}>
                <input value={websiteSearch} onChange={e => { setWebsiteSearch(e.target.value); setPage(1); }}
              ...
              <ColHeader col="comment" label="Note" filterActive={!!noteSearch}>
                <input value={noteSearch} onChange={e => { setNoteSearch(e.target.value); setPage(1); }}
